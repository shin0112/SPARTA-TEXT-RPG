...
| ShopScene에서의 변수 초기화와 생성자 평가 시점에 대해 | `Init()` 함수로 초기화 시점 변경 사용             | [🔗 [내일배움캠프 14일차 TIL] Init함수에 대해!!](https://nbcamp-unity12-jian.tistory.com/25)                                                                                                                                                                           |
| 상점에서 여러 개 한 번에 판매 처리하기 문제           | List의 인덱스 작동구조 이해                       | [🔗 [내일배움캠프 15일차 TIL] 상점기능 최종 트러블슈팅 2개!!](https://nbcamp-unity12-jian.tistory.com/26)                                                                                                                                                              |
